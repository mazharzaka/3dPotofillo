const BEATSHero = [
  {
    ...
    headline: "Mazhar.",
    sub: "Specialized in building high-performance web applications.",
    cta: null,
  },
  {
    from: 0.22,
    ...
    eyebrow: "Core Focus",
    headline: "Quality\nover Code.",
    sub: "Developing scalable frontend architectures with Next.js and React.",
    cta: null,
  },
  {
    from: 0.52,
    ...
    eyebrow: "Expertise",
    headline: "Full-Stack\nCapabilities.",
    sub: "MERN Stack Specialist & Cross-Platform Mobile Developer.",
    cta: "Download CV →",
  },
  {
    from: 0.82,
